...
async def play(_, message: Message):
    ...
    if audio:
        ...
        query = toxt
        await lel.edit("📡 <b>Processing</b> Your Request 📡")
    ...
    if chat_id in callsmusic.active_chats:
        ...
        await message.reply_photo(
            photo="final.png",
            reply_markup=keyboard,
            caption="▶️ <b>Playing</b> here the song requested by {} via 🃏 𝐉𝖔𝖐𝖊𝐫 𝕸𝖚𝖘𝖎𝖈 𝕬𝖘𝖘𝖎𝖘𝖙𝖆𝖓𝖙".format(
...
async def lol_cb(b, cb):
    ...
    if chat_id in callsmusic.active_chats:
        ...
        await b.send_photo(chat_id,
            photo="final.png",
            reply_markup=keyboard,
            caption=f"▶️ <b>Playing</b> here the song requested by {r_by.mention} via 🃏 𝐉𝖔𝖐𝖊𝐫 𝕸𝖚𝖘𝖎𝖈 𝕬𝖘𝖘𝖎𝖘𝖙𝖆𝖓𝖙",
        )
